...
1-2. RAM 중에서 대용량일 필요는 없고, 속도는 빨라야 할 때 사용할 수 있는 RAM은 무엇일까요?
<details> 
  <summary>정답</summary>
  SRAM입니다. SRAM은 DRAM보다 속도는 빠르지만, 집적도가 낮아서 용량이 작은 특징이 있습니다.
</details>

1-3. 속도도 빠르면서 용량도 커서 현대 컴퓨터에서 메인 메모리로 사용하는 RAM은 무엇일까요?
<details> 
  <summary>정답</summary>
  DDR입니다. DDR은 대역폭을 넓혀 SDRAM 대비 속도를 두 배로 높이고, 용량도 큰 편이어서 현대 컴퓨터의 메인 메모리로 작동하고 있습니다.
</details>
